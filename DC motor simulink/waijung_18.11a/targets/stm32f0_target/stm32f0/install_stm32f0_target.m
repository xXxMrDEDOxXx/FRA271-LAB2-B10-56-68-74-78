function install_stm32f0_target
    ...
    [stlinkavailable, stdriveravailable] = stm32f0.stLinkAvailable;
    ...
    if ~((stlinkavailable+stdriveravailable)==2)
        ...
        choice = questdlg(['It seems that ' missing_tool_str ' have NOT yet been installed on this computer. ' char([10 10]) ...
            'You should have ' missing_tool_str ' installed to take full advantage of Waijung and stm32f0 Target Auto Download capability.'  char([10 10]) ...
        ...
        switch choice
            case ['Proceed with Waijung installation without ' missing_tool_str ]
                ...
                str = [str 'You should manually install ' missing_tool_str ', and run Waijung installation again to take full advantage of Waijung and stm32f0 Target Auto Download capability.'];
