#define S_FUNCTION_NAME  stm32f4_digital_input
...
#define USE_GLOBALINIT(S) mxGetScalar(ssGetSFcnParam(S, 26)) /* Use Pin 15 */
...
static void mdlInitializeSizes(SimStruct *S) {
	...
	/* Port: P0 */
	if (USE_PIN0(S)){
		ssSetOutputPortDataType(S, portCnt, SS_BOOLEAN);
 ...
 * (e.g. must have TLC file stm32f4_digital_input.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function stm32f4_digital_input.c"
#endif
