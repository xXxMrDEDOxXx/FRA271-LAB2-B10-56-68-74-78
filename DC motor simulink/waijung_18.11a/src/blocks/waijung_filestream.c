#define S_FUNCTION_NAME  waijung_filestream
...
static void mdlRTW(SimStruct *S) {
	...
	inikeys = (char*)mxArrayToString(ssGetSFcnParam(S, ARGC_INIKEYS));
	...
	if (!ssWriteRTWStrVectParam(S, "inikeys", inikeys, get_list_count(inikeys))){
		return;
	}
 ...
 * (e.g. must have TLC file waijung_filestream.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function waijung_filestream.c"
#endif
