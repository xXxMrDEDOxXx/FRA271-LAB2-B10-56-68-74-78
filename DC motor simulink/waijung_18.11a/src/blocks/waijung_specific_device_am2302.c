#define S_FUNCTION_NAME  waijung_specific_device_am2302
...
static void mdlRTW(SimStruct *S) {
	...
	targetname = (char*)mxArrayToString(ssGetSFcnParam(S, ARGC_TARGETNAME));
    ...
    if (!ssWriteRTWParamSettings(S, NOutputPara,
			...
			SSWRITE_VALUE_QSTR, "targetname", targetname
            )) {
 ...
 * (e.g. must have TLC file waijug_specific_device_am2302.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function waijug_specific_device_am2302.c"
#endif
