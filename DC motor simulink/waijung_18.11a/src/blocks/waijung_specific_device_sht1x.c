#define S_FUNCTION_NAME  waijung_specific_device_sht1x
 ...
 * (e.g. must have TLC file waijug_specific_device_sht1x.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function waijug_specific_device_sht1x.c"
#endif
