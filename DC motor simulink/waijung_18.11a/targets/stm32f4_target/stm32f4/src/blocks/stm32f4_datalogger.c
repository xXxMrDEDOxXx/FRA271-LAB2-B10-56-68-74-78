#define S_FUNCTION_NAME  stm32f4_datalogger
...
static void mdlRTW(SimStruct *S) {
    int NOutputPara = 5; /* Number of parameters to output to model.rtw */
    ...
    header = (char*)mxArrayToString(ssGetSFcnParam(S, ARGC_HEADER));
    ...
    if (!ssWriteRTWParamSettings(S, NOutputPara,
			...
			SSWRITE_VALUE_QSTR, "header", header,
 ...
 * (e.g. must have TLC file stm32f4_datalogger.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function stm32f4_datalogger.c"
#endif
