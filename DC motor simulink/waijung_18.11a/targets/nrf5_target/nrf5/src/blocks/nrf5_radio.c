#define S_FUNCTION_NAME  nrf5_radio
...
static void mdlRTW(SimStruct *S) {
    ...
    char *conf; // ARCG_CONF
    char *optionstring, *headerstring, *terminatorstring;
    char *sampletimestr;
    char *blockid;
    
    conf = (char*)mxArrayToString(ssGetSFcnParam(S, ARCG_CONF));
	optionstring = (char*)mxArrayToString(ssGetSFcnParam(S, ARGC_OPTIONSTRING));
	headerstring = (char*)mxArrayToString(ssGetSFcnParam(S, ARGC_BINHEADER));
	terminatorstring = (char*)mxArrayToString(ssGetSFcnParam(S, ARGC_BINTERMINATOR));
 ...
 * (e.g. must have TLC file nrf5_radio.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function nrf5_radio.c"
#endif
