#define S_FUNCTION_NAME  waijung_stringbuffer_write
 ...
 * (e.g. must have TLC file waijung_stringbuffer_write.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function waijung_stringbuffer_write.c"
#endif
