#define S_FUNCTION_NAME  nrf5_mesh_serial
...
static void mdlInitializeSizes(SimStruct *S) {
    ...
    if(ENABLE_ISR(S) == 0) {
        ...
        /* options */
        ssSetOptions(S, (SS_OPTION_EXCEPTION_FREE_CODE | SS_OPTION_ASYNCHRONOUS_INTERRUPT));
 ...
 * (e.g. must have TLC file nrf5_nrf5_mesh_serial.tlc)  *
 *=======================================*/
#ifdef    MATLAB_MEX_FILE  /* Is this file being compiled as a MEX-file?    */
#include "simulink.c"     /* MEX-file interface mechanism                  */
#else                      /* Prevent usage by RTW if TLC file is not found */
#error "Attempted use non-inlined S-function nrf5_template.c"
#endif
